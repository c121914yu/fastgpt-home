...
const links = isCn
  ? {
      ...
      pricingZhTw: 'https://fastgpt.cn/zh-tw/price',
  ...
  : {
      ...
      pricingZhTw: 'https://fastgpt.io/zh-tw/price',
...
- Traditional Chinese LLM Context: ${baseUrl}/zh-tw/llms.txt
...
The Japanese, Arabic, Vietnamese, Thai, Indonesian, and Malay pages use this English LLM context file. Chinese uses ${baseUrl}/zh/llms.txt, and Traditional Chinese uses ${baseUrl}/zh-tw/llms.txt.
...
- 定价：${links.pricingZh}
- FAQ：${links.faqZh}
- 繁体中文 LLM Context：${baseUrl}/zh-tw/llms.txt
...
writeText('zh-tw/llms.txt', traditionalChineseContent);
